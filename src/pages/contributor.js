        ...
        return (
            <Layout>
                ...
                <div className="max-w-screen-lg mx-auto px-4 py-4">
                    ...
                    <div className="mt-12">
                         { this.props.data.allMarkdownRemark.edges.map(contrib => (
                             <a key={contrib.node.frontmatter.username} href={`/contributor/${contrib.node.frontmatter.username.toLowerCase()}`} className="p-3 border border-gray-300 rounded-lg mb-4 block bg-white shadow-sm hover:shadow-lg">
